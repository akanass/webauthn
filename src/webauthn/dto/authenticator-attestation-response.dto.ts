...
export class AuthenticatorAttestationResponseDto {
  ...
  @ApiProperty({
    ...
    required: true,
    example: 'eyJ0eXBlIjoid2ViYXV0aG4uY3JlYXRlIiwiY2hhbGxlbmdlIjoiUXljbWs2ckw1T0RMNzd6blJSUUhRMEpxNlZXRHVBWjRIOG8xT0pXV2lQYyIsIm9yaWdpbiI6Imh0dHBzOi8vYWthbmFzcy5sb2NhbDozMDAwIiwiY3Jvc3NPcmlnaW4iOmZhbHNlfQ',
  })
  @IsString()
  @IsNotEmpty()
